...
setup(name = 'django-cache-object',
    version = '1.0.0',
    description = 'This django module gives similar functionality like in django.db.models.loading',
    author = 'German Ilyin',
    author_email = 'germanilyin@gmail.com',
    url = 'https://github.com/yunmanger1/django-cache-object/',
    license = 'WTFPL',
